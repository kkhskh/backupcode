...
Examples:
  ...
  ./flush_reload 100000 0 1          # Stats with auto-threshold
```
...
|-------|-------------|---------|-----------------|
| fake_a | 49.4ms | 0.14ms | ✅ |
| fake_b | 59.7ms | 0.09ms | ✅ |
| distilgpt2 | 564.5ms | 210.8ms | ✅ |
| opt-125m | 1003.4ms | 16.9ms | ✅ |
| gpt2-medium | 2652.7ms | 55.5ms | ✅ |
...
|----------|-----------|--------|
| random | 50-100ms | Adds noise, ~30% accuracy reduction |
| bucket | 100-500ms | Quantizes timing, ~50% accuracy reduction |
| constant | 1000-3000ms | Pads to constant, ~90% accuracy reduction |
| gVisor | - | Syscall interception, partial protection |
| Firecracker | - | VM isolation, strong protection |
